...
happyExpList = Happy_Data_Array.listArray (0,34) ([1040,32,0,3840,16640,15360,1025,2049,4098,8196,8,0,0,24,48,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","num","'+'","'-'","'*'","'/'","'!'","'('","')'","'['","']'","'{'","'}'","%eof"]
...
happyReduction_1 (HappyTerminal (TNum happy_var_1))
	 =  HappyAbsSyn4
		 (Num happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TNum happy_dollar_dollar -> cont 5;
	TAdd -> cont 6;
	TSub -> cont 7;
	TMul -> cont 8;
	TDiv -> cont 9;
